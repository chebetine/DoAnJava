...
<body>
	...
	<aside id="sidebar" class="sidebar">
	  ...
	  <ul class="sidebar-nav" id="sidebar-nav">
	    ...
	    <li class="nav-item">
	      ...
	      <ul id="components-nav" class="nav-content nav-link " data-bs-parent="#sidebar-nav">
	        <li>
	          <a href="QuyenTC.jsp">
	...
	<main id="main" class="main">
	  ...
	  <div class="pagetitle">
	    <h1>Quyền truy cập vào website quản lý nhân sự</h1>
	    <nav>
	      <ol class="breadcrumb">
	          ...
	          <div class="col-12">
	            <div class="card recent-sales overflow-auto">
	              <div class="card-body mt-4">
	                <h5 class="card-title">Danh sách quyền truy cập</h5>
				    ...
				    <%
					      ...
					      try {
					          ...
					          if (connection != null) {
					              ...
					              out.println("<thead><tr><th>Họ tên</th><th>Ngày sinh</th><th>Giới tính</th><th>Quê quán</th><th>Chức vụ</th><th>Phân quyền</th></tr></thead>");
					              out.println("<tbody>");
					              while (resultSet.next()) {
					                  ...
					                  int quyen = resultSet.getInt("quyentc");
					                  ...
					                  out.println("<td>");
					                  out.println("<form action='PhanQuyen' method='POST'>");
					                  out.println("<input type='hidden' name='idNhanvien' value='" + idNhanvien + "'>");
					                  out.println("<input type='radio' name='quyen' value='1' " + (quyen == 1 ? "checked" : "") + "> Cấp quyền ");
					                  out.println("<input type='radio' name='quyen' value='0' " + (quyen == 0 ? "checked" : "") + "> Xóa quyền ");
					                  out.println("<button type='submit' class='btn btn-primary btn-sm'>Cập nhật</button>");
					                  out.println("</form>");
					                  out.println("</td>");
					                  out.println("</tr>");
					              }
					    ...
					    <%
						    ...
						    request.getSession().removeAttribute("errorMessage"); // Xóa thông báo sau khi hiển thị
						%>
