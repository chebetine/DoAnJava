		            ...
		            <div class="row">
		              <div class="col-md-12">
						<form action="XepLoai" method="post">
						        ...
						        <table id='add-row' class='display table table-striped table-hover'>
						            <thead>
						                <tr>
						                    ...
						                    <th scope='col'>Hiệu suất làm việc</th>
						                    <th scope='col'>Thái độ làm việc</th>
						                    <th scope='col'>Kỹ năng làm việc</th>
						                </tr>
						            </thead>
						            <tbody>
						                <%
						                    ...
						                    try {
						                        connection = KetNoi.getConnection();
						                        String query = "SELECT idnhanvien, hoten, chucvu FROM dsnhanvien";
						                        ...
						                        while (resultSet.next()) {
						                            ...
						                            out.println("<td><input type='number' name='hieusuat_" + idNhanVien + "' min='0' class='form-control' /></td>");
						                            out.println("<td><input type='number' name='thaido_" + idNhanVien + "' min='0' class='form-control' /></td>");
						                            out.println("<td><input type='number' name='kynang_" + idNhanVien + "' min='0' class='form-control' /></td>");
						        ...
						        <div class="ms-auto">
						        <input class="btn btn-primary btn-round" type="submit" value="Thêm Xếp Loại" />
								        </div>
						    </form>		              
					    </div>
		            </div>
