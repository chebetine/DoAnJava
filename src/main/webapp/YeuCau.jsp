	          ...
	          <div class="page-inner">
		          ...
		          <div class="page-inner">
		            <div class="page-header">
		              <h3 class="fw-bold mb-3">Tạo yêu cầu</h3>
		              <ul class="breadcrumbs mb-3">
		                ...
		                <li class="nav-item">
		                  <a href="DanhSachYC.jsp">Danh sách yêu cầu</a>
		                </li>
		                <li class="separator">
		                  <i class="icon-arrow-right"></i>
		                </li>
		                  ...
		                  <div class="card-header">
		                   <div class="container">
					          <div class="page-inner">
					            <div class="row">
					              <div class="col-md-12">
					               <form action="TaoYC" method="POST">
									    <div class="card">
									        <div class="card-header">
									            <div class="card-title">Tạo yêu cầu</div>
									        </div>
									        <div class="card-body">
									            <div class="row">
									                <div class="col-md-6 col-lg-4">
									                    <div class="form-group">
									                        <label for="name">Họ tên người yêu cầu</label>
									                        <select class="form-select form-control-lg" name="idNhanVien" required>
									                            ...
									                            <% 
									                                ...
									                                try {
									                                    connection = KetNoi.getConnection();
									                                    if (connection != null) {
									                                        String query = "SELECT idnhanvien, hoten FROM dsnhanvien";
									                            ...
									                            %>
									                            <option value="<%= idNhanVien %>"><%= hoTen %></option>
									                            <%
									                                        }
									                                    } else {
									                                        out.println("<option value=''>Không kết nối được cơ sở dữ liệu</option>");
									                                    }
									                                } catch (SQLException e) {
									                                    e.printStackTrace();
									                                    out.println("<option value=''>Lỗi khi truy vấn dữ liệu</option>");
									                                } finally {
									                                    try {
									                                        if (resultSet != null) resultSet.close();
									                                        if (connection != null) connection.close();
									                    ...
									                    <div class="form-group">
									                        <label for="ngayyc">Ngày yêu cầu</label>
									                        <input type="date" name="ngayyc" class="form-control" placeholder="Ngày YC" required />
									                    </div>
									                    <div class="form-group">
									                        <label for="largeSelect">Loại yêu cầu</label>
									                        <select class="form-select form-control-lg" name="loaiyc" id="largeSelect">
									                            <option> </option>
									                            <option value="Nghỉ phép">Nghỉ phép</option>
									                            <option value="Làm thêm">Làm thêm</option>
									                            <option value="Thay đổi thông tin hồ sơ">Thay đổi thông tin hồ sơ</option>
									                            <option value="Ứng lương">Ứng lương</option>
									                ...
									                <div class="col-md-6 col-lg-4">
									                    <div class="form-group">
									                        ...
									                        <input type="date" name="ngaybd" class="form-control" placeholder="Ngày BD" required />
									                    </div>
									                    <div class="form-group">
									                        <label for="ngaykt">Ngày kết thúc</label>
									                        <input type="date" name="ngaykt" class="form-control" placeholder="Ngày KT" required />
									                    </div>
									                    <div class="form-group">
									                        <label for="tthai">Trạng thái</label>
									                        <input type="text" name="tthai" class="form-control" placeholder="Trạng thái" required />
									                    </div>
									                    </div>
									                   <div class="col-md-6 col-lg-4">
									                    <div class="form-group">
									                        <label for="mota">Mô tả</label>
									                        <input type="text" name="mota" class="form-control" placeholder="Mô tả" required />
									                    </div>
									                    <div class="form-group">
									                        <label for="phanhoi">Phản hồi</label>
									                        <input type="text" name="phanhoi" class="form-control" placeholder="Phản hồi" required />
									                    </div>
									                </div>
									            </div>
									        </div>
