		              ...
		              <div class="col-md-12">
		                <div class="card">
						  ...
						  <div class="card-body">
						    <div class="table-responsive">
						      ...
						      try {
						          connection = KetNoi.getConnection();
						          if (connection != null) {
						              String query = "SELECT nv.idnhanvien, nv.hoten, nv.chucvu, cc.Thang, cc.Nam, cc.SoNgayFull, cc.NuaNgay, cc.NgayNghi, cc.GioLamThem, cc.DiemTong "
						                           + "FROM dsnhanvien nv "
						              ...
						              out.println("<thead><tr><th scope='col'>Họ tên</th><th scope='col'>Chức vụ</th><th scope='col'>Số ngày làm việc đầy đủ</th>"
						                        ...
						                        + "<th scope='col'>Chấm điểm</th><th scope='col' style='width: 10%'>Tùy chọn</th></tr></thead>");
						              out.println("<tbody>");
						              ...
						              while (resultSet.next()) {
						                  ...
						                  int songay = resultSet.getInt("SoNgayFull");
						                  int nuangay = resultSet.getInt("NuaNgay");
						                  int songaynghi = resultSet.getInt("NgayNghi");
						                  int sogio = resultSet.getInt("GioLamThem");
						                  int diemtong = resultSet.getInt("DiemTong");

						                  out.println("<tr>");
						                  out.println("<td>" + ten + "</td>");
						                  out.println("<td>" + chucvu + "</td>");
						                  out.println("<td>" + songay + "</td>");
						                  out.println("<td>" + nuangay + "</td>");
						                  out.println("<td>" + songaynghi + "</td>");
						                  out.println("<td>" + sogio + "</td>");
						  ...
						  %>
						    ...
						    <div class="ms-auto">
							  <a href="ChamCong.jsp" class="btn btn-primary btn-round">
							    Chấm công tháng mới
							  </a>
							</div>
						  </div>
