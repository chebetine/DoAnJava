	  ...
	  <script>
        function toggleParentMenu() {
            ...
            if (levelSelect.value === "1") {
                ...
                parentMenu.style.display = "block"; // Hiện dropdown menu cha
            }
        }
    </script>
	            ...
	            <div class="col-12">
	              <div class="card recent-sales overflow-auto">
	                <div class="card-body mt-4">
	                  ...
	                  <form action="ThemMN" method="post"> <!-- Ensure the form submits to the correct servlet -->
			            Cấp Menu: 
			            ...
			            <br/><br/>
			            Tên Menu: <input type="text" name="nameMN" required><br/><br/>
			            Menu cha: <br/><br/>
			            <select id="parentMenu" name="option2">
			                <%
			                    ...
			                    try {
			                        connection = KetNoi.getConnection(); // Kết nối tới cơ sở dữ liệu
			                        if (connection != null) { // Kiểm tra kết nối có hợp lệ không
			                            statement = connection.createStatement();
			                            resultSet = statement.executeQuery("SELECT idDSMenu, NameMenu FROM dsmenu WHERE Level = 1");
			
			                            // Nếu không có menu cha
			                            if (!resultSet.isBeforeFirst()) {
			                                out.println("<option value=''>Không có menu cha</option>");
			                            } else {
			                                while (resultSet.next()) {
			                                    int menuID = resultSet.getInt("idDSMenu");  // Lấy MenuID
			                                    String nameMenu = resultSet.getString("NameMenu");
			                                    out.println("<option value='" + menuID + "'>" + nameMenu + "</option>");  // Set MenuID là value
			                                }
			                            }
			                        } else {
			            ...
			            <br/>
			            Link Menu: <input type="text" name="link" required><br/><br/><br/>
